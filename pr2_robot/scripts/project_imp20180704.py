...
# Exercise-2 TODOs:
    ...
    msg_cov = ros_to_pcl(pcl_msg)
    
    # TODO: Statistical Outlier Filtering
    outlier_filter = msg_cov.make_statistical_outlier_filter() 
    ...
    extracted_outlier = cloud_filtered.extract(inliers, negative=True)

    white_cloud = XYZRGB_to_XYZ(extracted_outlier)      # Apply function to convert XYZRGB to XYZ 
...
if __name__ == '__main__':
    ...
    model = pickle.load(open('/home/robond/catkin_ws/src/RoboND-Perception-Project/pr2_robot/scripts/model_pick_3.sav', 'rb'))
